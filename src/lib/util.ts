...
export class HolipolyEventError extends Error {
  constructor(message: string) {
    super(message);
    this.name = 'HolipolyEventError';
  }
}
...
export class NotHolipolyAppDirectoryError extends Error {
  constructor(message = '') {
    super(message);
    this.name = 'NotHolipolyAppDirectoryError';
  }
}
...
export class HolipolyAppUninstallError extends Error {
  constructor(message = 'There is no Holipoly App with the provided ID') {
    super(message);
    this.name = 'HolipolyAppUninstallError';
  }
}
...
export class HolipolyEnvironmentError extends Error {
  constructor(message = '') {
    super(message);
    this.name = 'HolipolyEnvironmentError';
  }
}

export class HolipolyOrganizationError extends Error {
  constructor(message = '') {
    super(message);
    this.name = 'HolipolyOrganizationError';
  }
}

export class HolipolyAppError extends Error {
  constructor(message = '') {
    super(message);
    this.name = 'HolipolyAppError';
  }
}
...
export class HolipolyAppInstallError extends Error {
  constructor(
    message = 'Cannot install this Holipoly App. Check your connection and try again.',
  ) {
    super(message);
    this.name = 'HolipolyAppInstallError';
  }
}
...
export const promptHolipolyApp = async (argv: Options) =>
  createPrompt({
    name: 'app',
    message: 'Select a Holipoly App',
    fetcher: async () => {
...
export const promptCompatibleVersion = async ({
  ...
  createPrompt({
    ...
    message: 'Select a Holipoly service',
    fetcher: async () =>
    ...
    extractor: (_: any) => ({
      name: `Holipoly ${_.version} - ${_.display_name}`,
      value: _.name,
    }),
    json,
  });
...
export const waitForTask = async (
  ...
  let currentMsg = 0;
  const messages = [
    `🙌  If you see yourself working on tools like this one, Holipoly is looking
      for great educators and DevRel engineers.\n
      Contact us directly at careers@holipoly.io or DM on LinkedIn.`,
    `✨  Take your first steps with Holipoly's API by checking our tutorial at\n
      https://learn.holipoly.io`,
    `⚡  If you like React and Next.js, you may want to take a look at our
      storefront starter pack available at\n
      https://github.com/holipoly/react-storefront`,
  ];
...
export const verifyResultLength = (
  ...
  if (entities.includes(entity)) {
    console.warn(
      chalk(
        `  Create ${entity} with`,
        chalk.green(`holipoly ${entity} create`),
        'command',
      ),
    );
  }
