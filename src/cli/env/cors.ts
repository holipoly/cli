...
const debug = Debug('holipoly-cli:env:auth');
...
export const builder: CommandBuilder = (_) =>
  _.positional('key', {
    ...
    .example('holipoly env cors', '')
    .example('holipoly env cors my-environment --all', '')
    .example('holipoly env cors my-environment --dashboard', '')
    .example(
