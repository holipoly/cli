...
const debug = Debug('holipoly-cli:env:maintanance');
...
export const builder: CommandBuilder = (_) =>
  _.positional('key', {
    ...
    .example('holipoly env maintenance', '')
    .example('holipoly env maintenance my-environment', '')
    .example('holipoly env maintenance my-environment --enable', '')
    .example('holipoly env maintenance my-environment --disable', '');
