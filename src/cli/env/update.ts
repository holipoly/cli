...
const debug = Debug('holipoly-cli:env:update');
...
export const builder: CommandBuilder = (_) =>
  _.positional('key', {
    ...
    .example('holipoly env update', '')
    .example('holipoly env update my-environment', '')
    .example('holipoly env update my-environment --name=renamed-env', '');
