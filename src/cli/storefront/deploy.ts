...
const debug = Debug('holipoly-cli:storefront:deploy');
...
export const builder: CommandBuilder = (_) =>
  _.option('dispatch', {
    ...
    .example('holipoly storefront deploy --no-github-prompt', '')
    .example(
      'holipoly storefront deploy --organization="organization-slug" --environment="env-id-or-name" --no-github-prompt',
      '',
    );
...
export const handler = async (argv: Arguments<Deploy>) => {
  ...
  throw new CommandRemovedError(
    'This command has been removed\nPlease check documentation for `storefront` commands at https://github.com/holipoly/holipoly-cli/tree/main/docs',
  );
};
