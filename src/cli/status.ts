...
const debug = Debug('holipoly-cli:status');
  ...
  console.log(
    ` Holipoly API: ${
      token
        ...
        : `${chalk.red('Not logged')}   Run: holipoly login`
    }`,
  );
  ...
  console.log(
    `     Vercel: ${
      vercel
        ...
        : `${chalk.red('Not logged')}   Run: holipoly vercel login`
    }`,
  );
  ...
  console.log(
    `     GitHub: ${
      github
        ...
        : `${chalk.red('Not logged')}   Run: holipoly github login`
    }`,
  );
};
