...
const debug = Debug('holipoly-cli:register');

export const command = ['register', 'signup'];
export const desc = 'Create a Holipoly Cloud account';
...
export const handler = async (argv: Arguments) => {
  ...
  const link = 'https://cloud.holipoly.io/signup';

  console.log(
    `\nUse the following link:\n${chalk.blue(
      link,
    )}\nto create a Holipoly Cloud account.\n`,
  );
